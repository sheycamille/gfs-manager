...
//Shipment Section
Route::get('shipment/dashboard', [ShipmentController::class, 'dashboard'])->name('shipment.dashboard')->middleware(['auth', 'XSS']);
Route::get('add-shipment', [ShipmentController::class, 'create'])->name('shipment.create')->middleware(['auth', 'XSS']);
Route::post('store-shipment', [ShipmentController::class, 'store'])->name('shipment.store')->middleware(['auth', 'XSS']);
Route::get('all-shipment', [ShipmentController::class, 'allShipment'])->name('shipment.all.show')->middleware(['auth', 'XSS']);
Route::get('shipment/{id}/edit', [ShipmentController::class, 'edit'])->name('shipment.edit')->middleware(['auth', 'XSS']);
Route::put('shipment/edit/{id}', [ShipmentController::class, 'update'])->name('shipment.update')->middleware(['auth', 'XSS']);
Route::delete('shipment/delete/{id}', [ShipmentController::class, 'destroy'])->name('shipment.destroy')->middleware(['auth', 'XSS']);
Route::get('track-shipment', [ShipmentController::class, 'trackShipment'])->name('shipment.track')->middleware(['auth', 'XSS']);
// Route::post('track-result', [ShipmentController::class, 'trackingResult'])->name('shipment.track.result')->middleware(['auth', 'XSS']);

//Business development & partnerships
Route::get('prospecting', [BussinessDevelopmentCOntroller::class, 'prospecting'])->name('bussiness.prospecting')->middleware(['auth', 'XSS']);
Route::get('customer-relationship', [BussinessDevelopmentCOntroller::class, 'customerRelationship'])->name('bussiness.customer')->middleware(['auth', 'XSS']);
Route::get('sales-opportunity', [BussinessDevelopmentCOntroller::class, 'salesOpportunity'])->name('bussiness.sales')->middleware(['auth', 'XSS']);

//Marketing & Communication
Route::get('market-strategy', [MarketingManagementcontroller::class, 'marketStrategy'])->name('market.strategy')->middleware(['auth', 'XSS']);
Route::get('market-campaigns', [MarketingManagementcontroller::class, 'marketCampaigns'])->name('market.campaigns')->middleware(['auth', 'XSS']);
Route::get('posts', [MarketingManagementcontroller::class, 'allPost'])->name('post.all')->middleware(['auth', 'XSS']);
Route::get('post/create', [MarketingManagementcontroller::class, 'createPost'])->name('post.create')->middleware(['auth', 'XSS']);
