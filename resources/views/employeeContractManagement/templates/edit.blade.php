...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item">{{__('Employee Contract Template')}}</li>
@endsection
@push('css-page')
        ...
        <div class="col-12 col-md-9">
            <div class="card">
                <div class="card-body table-border-style">
                    ...
                    {{ Form::open(array('url' => 'employees/contract/template/'.$template->id.'/update')) }}
                        <div class="modal-body">
                            ...
                            <div class="row">
                                <div class="form-group col-md-12">
                                    ...
                                    <textarea class="form-control summernote-simple" id="exampleFormControlTextarea2" rows="8">{{ $template->content }}</textarea>
