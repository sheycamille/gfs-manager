                ...
                <div class="card-body table-border-style">
                    ...
                    <form action="{{ $url }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-6 d-flex align-items-center justify-content-center">
                                    ...
                                    <div class="form-check form-switch mx-2">
                                        <input class="form-check-input" type="checkbox" id="flexSwitchCheckDefault" {{ $contract->template_id == null? "checked":"" }}>
                                ...
                                <div class="form-group col-md-6">
                                    <div id="template-container" class="{{ $contract->template_id != null? "":"d-none" }}">
                                        ...
                                        <select name="template_id" id="template_id" class="form-control">
                                            ...
                                            @foreach($templates as $template)
                                                <option 
                                                    value="{{ $template->id }}" 
                                                    {{ $template->id == $contract->template_id?'selected':"" }}
                                                    >{{ $template->name }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                    <div id="file-container" class="{{ $contract->template_id == null? "":"d-none" }}">
                            ...
                            <div class="row {{ $contract->template_id != null? "":"d-none" }}" id="description-container">
                                <div class="form-group col-md-12">
                                    {{ Form::label('description', __('Description'),['class'=>'form-label']) }}
                                    <textarea name="description" id="description" class="form-control summernote-simple-2" cols="30" rows="3"> {{ $contract->description }} </textarea>
                                </div>
                            </div>
                        </div>
                        </div>
