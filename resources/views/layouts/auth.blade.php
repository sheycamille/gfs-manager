...
<head>
    ...
    <!-- Favicon icon -->
    <link rel="icon" href="{{$logo.'/'.(isset($company_favicon) && !empty($company_favicon)?'gfs_fav_icon.png':'gfs_fav_icon.png')}}" type="image/x-icon"/>
                ...
                <nav class="navbar navbar-expand-md default">
                    <div class="container">
                        ...
                        <a class="navbar-brand" href="#">
                            @if ($setting['cust_darklayout'] == 'on')
                                <img class="logo"
                                    src="{{ $logo .'/'. (isset($company_logo) && !empty($company_logo) ? 'GFS_Logo.png' : 'GFS_Logo.png')  }}"
                                    alt="" loading="lazy"/>
                            @else
                                <img class="logo"
                                    src="{{ $logo .'/'. (isset($company_logo) && !empty($company_logo) ? 'GFS_Logo.png' : 'GFS_Logo.png') }}"
