...
@if (isset($setting['cust_theme_bg']) && $setting['cust_theme_bg'] == 'on')
    <header class="dash-header transprent-bg px-4" style="max-width: 100" id="header">
@else
    <header class="dash-header px-4" style="max-width: 100" id="header">
@endif
            ...
            <div class="me-auto dash-mob-drp">
                <div class="row align-items-center">
                    <div class="col-sm-2 d-none d-md-block">
                        <a href="#" class="text-muted" onclick="closeNav()" id="closenav">
                        ...
                        <a href="#" class="text-muted d-none" onclick="openNav()" id="opennav">
                ...
                <ul class="list-unstyled">
                    ...
                    @if( \Auth::user()->type !='client' && \Auth::user()->type !='super admin' )
                        ...
                        <a
                            ...
                            aria-expanded="false"
                        >
                            @if(strtolower($LangName->code) == "en")
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            @endif
                            @if(strtolower($LangName->code) == "fr")
                            ...
                            <span class="drp-text hide-mob">{{strtoupper($LangName->code)}}</span>
                    ...
                    <li class="dropdown dash-h-item drp-company">
                        ...
                        >
                            ...
                            <span class="hide-mob ms-2" >
                                ...
                                <p class="text-xs text-muted text-center">{{ Auth::user()->roles? Auth::user()->roles[0]->name:"" }}</p>
                            </span>
