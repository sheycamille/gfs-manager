...
<body style="margin: 0; padding: 0; font-family: Arial, sans-serif; background-color: #f4f4f4;">
    <table align="center" border="0" cellpadding="0" cellspacing="0" width="600" style="border-collapse: collapse; border: 1px solid #cccccc; background-color: #ffffff;">
                ...
                <table border="0" cellpadding="0" cellspacing="0" width="100%">
                    ...
                    <tr>
                        <td style="color: #153643; font-family: Arial, sans-serif; font-size: 16px; line-height: 20px;">
                            The was a new sign in request to your account. This OTP is valid for 10 minutes.
                        </td>
                    </tr>
                </table>
            </td>
        ...
        <tr>
            <td bgcolor="#ee4c50" style="padding: 30px 30px; text-align: center; color: white; font-family: Arial, sans-serif; font-size: 14px;">
                If you did not request this code, please ignore this email or contact support if you feel something is wrong.<br/>
                <a href="#" style="color: #ffffff; font-weight: bold;">Contact Support</a>
            </td>
        </tr>
    </table>
</body>
